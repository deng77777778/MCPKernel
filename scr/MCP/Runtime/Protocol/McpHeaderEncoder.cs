...
namespace MCP.Protocol
{
    ...
    public static class McpHeaderEncoder
    {
        ...
        /// <summary>
        /// Converts a <see cref="JToken"/> value to an encoded header value string.
        /// </summary>
        ...
        public static string? ConvertToHeaderValue(JToken node)
        {
            if (node == null)
            {
                return null;
            ...
            object? value = node.Type switch
            {
                JTokenType.String => (string)node!,
                JTokenType.Integer => node.ToString(),
                JTokenType.Float => node.ToString(),
                JTokenType.Boolean => (bool)node,
                _ => null
            };
