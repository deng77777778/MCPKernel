...
namespace MCP.Protocol
{
    ...
    public static class McpProtocolVersions
    {
        ...
        /// </summary>
        internal static readonly string[] InitializeHandshakeProtocolVersions = new string[]
        {
        ...
        /// </summary>
        internal static readonly string[] PerRequestMetadataProtocolVersions = new string[]
        {
        ...
        /// </summary>
        internal static readonly string[] SupportedProtocolVersions = new string[]
        {
            November2024ProtocolVersion,
            March2025ProtocolVersion,
            June2025ProtocolVersion,
