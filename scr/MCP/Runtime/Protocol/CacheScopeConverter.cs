...
namespace MCP.Protocol
{
    ...
    {
        public override CacheScope? ReadJson(JsonReader reader, Type objectType, CacheScope? existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
        ...
        public override void WriteJson(JsonWriter writer, CacheScope? value, JsonSerializer serializer)
        {
            if (value == null)
            {
                writer.WriteNull();
