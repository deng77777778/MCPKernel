...
namespace MCP.Protocol
{
    ...
    public class ResultOrAlternate<TResult> where TResult : Result
    {
        ...
        private readonly Type? _alternateType;
        /// <summary>
        ...
        private ResultOrAlternate(Result alternate, Type alternateTypeInfo)
        {
            if (alternate is null)
                throw new ArgumentNullException(nameof(alternate));
            if (alternateTypeInfo is null)
                throw new ArgumentNullException(nameof(alternateTypeInfo));
            _alternate = alternate;
            _alternateType = alternateTypeInfo;
        }
        ...
        public static ResultOrAlternate<TResult> FromAlternate<TAlternate>(TAlternate alternate, Type alternateType)
            where TAlternate : Result
            => new(alternate, alternateType);
        /// <summary>
        ...
        /// </summary>
        public Type? AlternateType=> _alternateType;
