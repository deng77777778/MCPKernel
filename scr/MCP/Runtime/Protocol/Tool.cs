...
namespace MCP.Protocol
{
    ...
    {
        private JToken inputSchema = McpJsonUtilities.DefaultJsonSchema;
        private JToken? outputSchema;
        /// <inheritdoc />
        [JsonProperty("name")]
        ...
        public JToken? OutputSchema
        {
            ...
            set
            {
                if (value is not null && !McpJsonUtilities.IsValidToolOutputSchema(value))
                {
