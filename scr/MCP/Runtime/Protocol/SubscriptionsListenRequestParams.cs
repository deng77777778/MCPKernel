...
namespace MCP.Protocol
{
    ...
    public sealed class SubscriptionsListenRequestParams : RequestParams
    {
        ...
        public SubscriptionsListenNotifications? Notifications { get; set; }
    }
    ...
    public sealed class SubscriptionsListenNotifications
    {
        ...
        /// </summary>
        [JsonProperty("promptsListChanged")]
        ...
        /// </summary>
        [JsonProperty("resourcesListChanged")]
        ...
        /// </remarks>
        [JsonProperty("resourceSubscriptions")]
